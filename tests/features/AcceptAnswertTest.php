...
{
   function test_the_posts_autor_can_accept_a_comment_as_the_post_asnwer()
    {
    ...
    function test_non_posts_autor_dont_see_accept_answer_button()
    {
        $comment = factory(Comment::class)->create([
            'comment' => 'Esta va a ser la respuesta del post '
        ]);
    ...
    function test_non_posts_autor_cannot_accept_a_comment_as_the_post_asnwer()
    {
        $comment = factory(Comment::class)->create([
            'comment' => 'Esta va a ser la respuesta del post '
        ]);
